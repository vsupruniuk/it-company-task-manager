...
from manager.models import Project, Task, Worker
...
class GetProjectsWithTasksTests(TestCase):
    def setUp(self) -> None:
        ...
        self.worker_tony = Worker.objects.create(
            first_name="Tony",
            last_name="Stark",
            username="t.stark",
            password="Qwerty12345!",
        )
        self.worker_bruce = Worker.objects.create(
            first_name="Bruce",
            last_name="Banner",
            username="b.banner",
            password="Qwerty12345!",
        )
        self.worker_thor = Worker.objects.create(
            first_name="Thor",
            last_name="Odinson",
            username="t.odinson",
            password="Qwerty12345!",
        )
        self.worker_steve = Worker.objects.create(
            first_name="Steve",
            last_name="Rogers",
            username="s.rogers",
            password="Qwerty12345!",
